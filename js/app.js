document.addEventListener('DOMContentLoaded', () => {
                    ...
                    fetch('server/task/index.php?user_id=' + data.user_id)
                        ...
                        .then(tks => {
                            ...
                            tks.forEach(task => {
                                ...
                                if (!task.complete) {
                                    buttons += `<button class="complete-btn" onclick="completeTask(${task.id})">Completar</button>`;
    ...
    form.addEventListener('submit', function (e) {
        ...
        postData.append('complete', complete.checked ? 1 : 0);
